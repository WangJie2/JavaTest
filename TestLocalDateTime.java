...
public class TestLocalDateTime {
	...
	public void test2(){
		...
		long epochSecond = ins.toEpochMilli();
	...
	public void test3(){
		...
		LocalDate ld2 = LocalDate.of(2017, 3, 1);

		Period pe = Period.between(ld2, ld1);
		System.out.println("年："+pe.getYears());
		System.out.println("月："+pe.getMonths());
		System.out.println("日："+pe.getDays());
	}
...
//		DateTimeFormatter dtf = DateTimeFormatter.ISO_LOCAL_DATE;
		...
		TemporalAccessor parse = dtf.parse(strDate);
